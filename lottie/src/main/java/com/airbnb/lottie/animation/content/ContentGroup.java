...
public class ContentGroup implements DrawingContent, PathContent,
    ...
    private static List<Content> contentsFromModels(LottieDrawable drawable, BaseLayer layer,
        ...
        for (ContentModel contentModel : contentModels) {
            Content content = contentModel.toContent(drawable, layer);
            if (content != null) {
    ...
    public void draw(Canvas canvas, Matrix parentMatrix, int parentAlpha) {
        ...
        boolean isRenderingWithOffScreen = false;
    ...
    private void union(RectFloat rect, float left, float top, float right, float bottom) {
