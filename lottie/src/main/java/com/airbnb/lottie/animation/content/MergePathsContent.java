...
public class MergePathsContent implements PathContent, GreedyContent {
    ...
    public Path getPath() {
        ...
        switch (mergePaths.getMode()) {
            ...
            case SUBTRACT:
            case INTERSECT:
                opFirstPathWithRest(Path.AddPathMode.APPEND_ADD_PATH_MODE);
                break;
            //case SUBTRACT:
            //    opFirstPathWithRest(Path.AddPathMode.APPEND_ADD_PATH_MODE);
                //break;
            ...
            case EXCLUDE_INTERSECTIONS:
                opFirstPathWithRest(Path.AddPathMode.EXTEND_ADD_PATH_MODE);
                break;
        }
    ...
    private void opFirstPathWithRest(Path.AddPathMode op) {
        remainderPath.reset();
        firstPath.reset();
