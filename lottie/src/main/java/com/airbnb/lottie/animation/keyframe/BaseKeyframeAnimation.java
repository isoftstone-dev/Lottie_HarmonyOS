...
public abstract class BaseKeyframeAnimation<K, A> {
    ...
    public void setProgress(float progress) {
        if (progress < 0 || progress > 1) {
            throw new NumberFormatException("progress must from 0 to 1");
        }
    ...
    private float getStartDelayProgress() {
        ...
        if (cachedStartDelayProgress < 0 || cachedStartDelayProgress > 1) {
            //throw new NumberFormatException("cachedStartDelayProgress must be from 0 to 1");
        }
    ...
    float getEndProgress() {
        ...
        if (cachedEndProgress < 0 || cachedEndProgress > 1) {
            //throw new NumberFormatException("cachedStartDelayProgress must be from 0 to 1");
        }
