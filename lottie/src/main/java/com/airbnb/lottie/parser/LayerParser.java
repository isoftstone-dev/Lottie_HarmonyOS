...
public class LayerParser {
  ...
  public static Layer parse(LottieComposition composition) {
    RectFloat bounds = composition.getBounds();
    return new Layer(
        ...
        new AnimatableTransform(), 0, 0, 0, 0, 0,
            (int)bounds.getWidth(), (int)bounds.getHeight(), null, null, Collections.<Keyframe<Float>>emptyList(),
    ...
    while (reader.hasNext()) {
      switch (reader.selectName(NAMES)) {
        ...
        case 6:
          ...
          break;
        case 7:
          solidColor = Color.getIntColor(reader.nextString());
          break;
        case 8:
